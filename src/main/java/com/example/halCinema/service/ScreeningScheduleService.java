...
public class ScreeningScheduleService {
    ...
    public static List<Object[]> findSelectScreeningSchedule(Integer screeningScheduleId) {
        return ScreeningScheduleRepositoty.findSelectScreeningSchedule(screeningScheduleId);
    }
    

	//  本日の上映タイトル取得
    public static List<Object[]> findSelectScreeningTitle(LocalDate nowDate) {
        return ScreeningScheduleRepositoty.findSelectScreeningTitle(nowDate);
    }
    
    
	//  指定タイトルの上映スクリーン取得
    public static List<Object[]> findSelectScreeningScreen(Integer movieId, LocalDate nowDate) {
        return ScreeningScheduleRepositoty.findSelectScreeningScreen(movieId, nowDate);
    }
    
    
	//  指定スクリーンの上映時間取得
    public static List<Object[]> findSelectScreeningDatetime(Integer screenId, LocalDate nowDate, Integer movieId) {
