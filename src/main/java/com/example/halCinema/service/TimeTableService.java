...
import com.example.halCinema.repository.TimeTableRepository;
...
public class TimeTableService {
    ...
    public List<Object[]> findFreeTime(Integer screenId, Integer runningTime) {
        return TimeTableRepository.findFreeTime(screenId, runningTime);
    }
    

    //  空き状況を空きなしに更新
    public void updateTrueFreeStatus(Integer timeId, Integer screenId) {
    	TimeTableRepository.updateTrueFreeStatus(timeId, screenId);
    }
    

    //  空き状況を空きありに更新
    public void updateFalseFreeStatus(Integer timeId, Integer screenId) {
    	TimeTableRepository.updateFalseFreeStatus(timeId, screenId);
    }
}
